...
void test_hmm_frame_state_0eps(void)
{
    ...
    nmm_base_set_lprob(base, 'T', LOG0);
...
void test_hmm_frame_state_len2(void)
{
    ...
    cass_close(imm_hmm_viterbi(hmm, "TG", imm_state_cast_c(state)),
               -3.2434246977896133);
...
void test_hmm_frame_state_len3(void)
{
    ...
    cass_close(imm_hmm_viterbi(hmm, "ATC", imm_state_cast_c(state)),
               -7.012344487235739);
    cass_close(imm_hmm_viterbi(hmm, "ATG", imm_state_cast_c(state)),
               -0.639793371602465);
...
void test_hmm_frame_state_len4(void)
{
    ...
    cass_close(imm_hmm_viterbi(hmm, "ATCC", imm_state_cast_c(state)),
               -11.982929094215963);
