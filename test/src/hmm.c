...
void test_hmm_frame_state_0eps(void)
{
    ...
    imm_path_append(path, imm_step_create(nmm_frame_state_parent(state), 3));
    ...
    imm_path_append(path, imm_step_create(nmm_frame_state_parent(state), 2));
    seq = imm_seq_create("AT", abc);
...
void test_hmm_frame_state_len1(void)
{
    ...
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -6.0198640216);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -6.0198640216);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
    ...
    path = imm_path_create();
    seq = imm_seq_create("C", abc);
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -7.1184763103);
...
void test_hmm_frame_state_len2(void)
{
    ...
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -8.910235779525845);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -8.910235779525845);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
    ...
    path = imm_path_create();
    seq = imm_seq_create("TG", abc);
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -3.2434246977896133);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -3.2434246977896133);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
    ...
    path = imm_path_create();
    seq = imm_seq_create("CC", abc);
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -4.225022885864217);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -4.225022885864217);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
    ...
    path = imm_path_create();
    seq = imm_seq_create("TT", abc);
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -5.326716841069734);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -5.326716841069734);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
...
void test_hmm_frame_state_len3(void)
{
    ...
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -7.012344487235739);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -7.012344487235739);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
    ...
    path = imm_path_create();
    seq = imm_seq_create("ATG", abc);
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -0.639793371602465);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -0.639793371602465);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
...
void test_hmm_frame_state_len4(void)
{
    ...
    struct imm_path* path = imm_path_create();
    imm_path_append(path, imm_step_create(nmm_frame_state_parent(state), 4));
    ...
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -11.982929094215963);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -11.982929094215963);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
...
void test_hmm_frame_state_len5(void)
{
    ...
    struct imm_path* path = imm_path_create();
    imm_path_append(path, imm_step_create(nmm_frame_state_parent(state), 5));
    ...
    cass_cond(!imm_lprob_is_valid(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path)));
    cass_cond(!imm_lprob_is_valid(imm_hmm_likelihood(hmm, seq, path)));
    imm_seq_destroy(seq);
    imm_path_destroy(path);
    ...
    path = imm_path_create();
    seq = imm_seq_create("ACTAG", abc);
    cass_close(single_viterbi(hmm, seq, nmm_frame_state_parent(state), path), -10.11420858385178);
    cass_close(imm_hmm_likelihood(hmm, seq, path), -10.11420858385178);
    imm_seq_destroy(seq);
    imm_path_destroy(path);
