...
void test_hmm_io(void)
{
    ...
    struct nmm_base_table const* baset =
        nmm_base_table_create(base, logf(0.25), logf(0.25), logf(0.5), zero);
    ...
    imm_hmm_add_state(hmm, nmm_frame_state_super(state1), logf(1.0));
    imm_hmm_add_state(hmm, nmm_codon_state_super(state2), logf(0.0001));
    imm_hmm_set_trans(hmm, nmm_frame_state_super(state1), nmm_codon_state_super(state2), logf(0.2));
