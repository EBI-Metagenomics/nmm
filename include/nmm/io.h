...
NMM_API struct nmm_codon_lprob const* nmm_io_codon_lprob(struct nmm_io const* io, uint32_t index);
NMM_API struct nmm_codon_table const* nmm_io_codon_table(struct nmm_io const* io, uint32_t index);
