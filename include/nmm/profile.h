...
NMM_API uint8_t                       nmm_profile_nhmm_blocks(struct nmm_profile const* prof);
NMM_API void                          nmm_profile_destroy(struct nmm_profile const* prof);
...
NMM_API struct nmm_profile const*     nmm_profile_read(FILE* stream);
