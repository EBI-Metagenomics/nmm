...
NMM_API int    nmm_codonp_set_lprob(struct nmm_codonp* codonp, struct nmm_codon const* codon,
                                    double lprob);
NMM_API double nmm_codonp_get_lprob(struct nmm_codonp const* codonp,
