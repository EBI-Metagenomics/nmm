...
NMM_EXPORT struct nmm_amino_abc const* nmm_amino_abc_create(struct imm_abc const* abc);
NMM_EXPORT void nmm_amino_abc_destroy(struct nmm_amino_abc const* amino_abc);

static inline struct imm_abc const* nmm_amino_abc_cast(struct nmm_amino_abc const* amino_abc)
{
