...
NMM_EXPORT struct nmm_codon_state const* nmm_codon_state_derived(struct imm_state const* state);
NMM_EXPORT void                    nmm_codon_state_destroy(struct nmm_codon_state const* state);
NMM_EXPORT struct imm_state const* nmm_codon_state_super(struct nmm_codon_state const* state);
