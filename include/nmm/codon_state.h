...
NMM_API struct nmm_codon_lprob const* nmm_codon_state_codon_lprob(
    struct nmm_codon_state const* state);
NMM_API struct nmm_codon_state const* nmm_codon_state_create(char const*                   name,
...
NMM_API struct imm_state const* nmm_codon_state_read(FILE* stream, struct nmm_model const* model);
NMM_API struct imm_state const* nmm_codon_state_super(struct nmm_codon_state const* state);
NMM_API int nmm_codon_state_write(struct imm_state const* state, struct nmm_model const* model,
                                  FILE* stream);
